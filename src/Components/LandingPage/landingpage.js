    ...
    <>
      ...
      <ScrollControls pages={6} dumping={0.25}>
        ...
        <>
          ...
          <div className="container hero-section" style={{width: '100vw', paddingTop: "20px", paddingBottom: "120px"}}>
            <div className="hero-section-content">
              <div className='d-flex justify-content-center text-center'>
                <h1 className="text-center hero-header" style={{marginTop: '2%'}}> We are a Creative Digital Agency</h1>
              </div>
              <div className='d-flex justify-content-center' style={{marginTop: '70px'}}>
                <button className="hero-call-to-action" onClick={()=>{window.location.href="/buildtogether"}}>
                  <span>Build something Together</span>
                  <FaArrowRight style={{ marginLeft: '5px' }} />
                </button>
                <button className="hero-call-to-action" style={{ marginLeft: '30px' }} onClick={()=>{window.location.href="/joinus"}}>
                  <span>Join Us</span>
                  <FaArrowRight style={{ marginLeft: '5px' }} />
                </button>
              </div>
